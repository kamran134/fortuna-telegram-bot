...
export declare function appointmentToTheGame(query: CallbackQuery, bot: any): Promise<void>;
export declare function notConfirmedAttendance(query: CallbackQuery, bot: any): Promise<void>;
export declare function declineAppointment(query: CallbackQuery, bot: any): Promise<void>;
