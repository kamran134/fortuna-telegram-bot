...
export async function getGamePlayers(pool: Pool, chatId: number): Promise<GamePlayer[]> {
    try {
...
export async function getUndecidedPlayers(pool: Pool, chatId: number): Promise<UndecidedPlayer[]> {
    try {
...
export async function addGamePlayerByLabel(pool: Pool, { gameLabel, chatId, userId, confirmed_attendance }: GamePlayerOptions): Promise<void> {
    try {
...
export async function addGamePlayerById(pool: Pool, { gameId, chatId, userId, confirmed_attendance }: GamePlayerOptions): Promise<string | undefined> {
    try {
