...
export async function getJoke(pool: Pool, jokeType: JokeTypes): Promise<string | undefined> {
    try {
...
export async function addJoke(pool: Pool, joke: string, jokeType: JokeTypes): Promise<void> {
    try {
...
export async function getJokes(pool: Pool, jokeType?: JokeTypes): Promise<Joke[] | undefined> {
    try {
...
export async function updateJoke(pool: Pool, jokeId: number, joke: string, jokeType?: JokeTypes): Promise<void> {
    try {
        if (jokeType) {
