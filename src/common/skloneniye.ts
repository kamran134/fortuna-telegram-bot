type Case = 'именительный' | 'родительный' | 'дательный' | 'винительный' | 'творительный' | 'предложный';
type CaseAz = 'именительный' | 'родительный' | 'дательный' | 'винительный' | 'местный' | 'исходный';
type WeekDay = 'понедельник' | 'вторник' | 'среда' | 'четверг' | 'пятница' | 'суббота' | 'воскресенье';

export function skloneniye(weekDay: string, padezh: string): string {
    const skloneniya: Record<WeekDay, Record<Case, string>> = {
        'понедельник': {
    ...
    return skloneniya[weekDay as WeekDay]?.[padezh as Case] || weekDay;
}

export function skloneniyeAz(weekDay: string, padezh: string): string {
    const skloneniya: Record<WeekDay, Record<CaseAz, string>> = {
        'понедельник': {
    ...
    return skloneniya[weekDay as WeekDay]?.[padezh as CaseAz] || weekDay;
}

export function skloneniyeAzFull(weekDay: string, padezh: string): string {
    const skloneniya: Record<WeekDay, Record<CaseAz, string>> = {
        'понедельник': {
            'именительный': 'bazar ertəsi',
            'родительный': 'bazar ertəsinin',
